      ...
      {items.length > 0 && (
        <div className="flex flex-col gap-3 border-t border-[var(--border)] p-5">
          ...
          <button
            ...
            className="flex h-12 w-full items-center justify-center gap-2 rounded-[var(--radius-pill)] bg-[var(--primary)] font-brand text-base font-semibold text-white transition-colors hover:bg-[var(--primary)]/90"
          >
  ...
  return (
    <>
      <div className="flex h-16 items-center justify-between border-t border-[var(--border)] bg-[var(--card)] px-5 lg:hidden">
        ...
        <button
          onClick={handlePayClick}
          className="rounded-[var(--radius-pill)] bg-[var(--primary)] px-6 py-2 font-brand text-sm font-semibold text-white transition-colors hover:bg-[var(--primary)]/90"
        >
          {t("pay")} {formatCurrency(total())}
        </button>
      </div>
