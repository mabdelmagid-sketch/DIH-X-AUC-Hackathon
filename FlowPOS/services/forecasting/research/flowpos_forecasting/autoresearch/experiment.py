...
Current best: 5,133,764 DKK (soft P^0.25 LGB clf(500) * RF(500)+ET(800) 70/30 hl=12d buf=1.30).
Next candidate: + residual feedback features → 3,467,408 DKK shelf-aware (-32.5%) on fast model.
Residuals in evaluate.py, 8 new features. Needs full model run to confirm.
