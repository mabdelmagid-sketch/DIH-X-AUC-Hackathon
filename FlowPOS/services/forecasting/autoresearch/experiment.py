...
Current best: 5,235,216 DKK (RF(300,min_leaf=2) global + ET(800) per-store 75/25 + decay hl=12d + 24% buffer).
...
if __name__ == "__main__":
    ...
    results = run_experiment(
        ...
        description="Adaptive blend RF(300) global + ET(800) per-store 75/25 + decay hl=12d + 25% buffer",
